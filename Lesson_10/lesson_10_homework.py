...
class Generate_files:
    os.mkdir("c:/automation_qwallity_06-24/Lesson_10/juli") #Anna - path is hardcoded 
...
# Anna - Would be better in the Generate_files class to have separate method and under it implement all this functionality
#  Becauase in this case every time you create object all this functionality will be called

# Anna - Overall good job and correct usage of the class and object