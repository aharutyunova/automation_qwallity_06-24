...
# expected_result=sample_str.replace(changeable_word,replace_word)
# print(expected_result)

# Anna - the inputs are not understandab;le in the console
# Not clear you request some input
...
# Anna - you reversed the whole string npot only 123 numbers
...
# Anna - no need for open file you just need to replcase one word to onather in the string
...
# Anna correct, but again in case you want to request any input, write something like input number, don't write 3 as a hint, 
# like in line 93
...
# Please make more attention in case you use inputs. And it is not always suitable to use input, try keep solution as simple as possible
