...
elif day in day_list_1 and month == month_12:
        print(month_name_12, season_4)
elif day in day_list_1 and month == month_3:
        print(month_name_3, season_1) 
elif day in day_list_1 and month == month_4:
        print(month_name_4, season_1)
elif day in day_list_1 and month == month_5:
        print(month_name_5, season_1) 
elif day in day_list_1 and month == month_6:
        print(month_name_6, season_2) 
elif day in day_list_1 and month == month_7:
        print(month_name_7, season_2)
elif day in day_list_1 and month == month_8:
        print(month_name_8, season_2)
elif day in day_list_1 and month == month_9:
        print(month_name_9, season_3)
elif day in day_list_1 and month == month_10:
        print(month_name_10, season_3)
elif day in day_list_1 and month == month_11:
        print(month_name_11, season_3)
