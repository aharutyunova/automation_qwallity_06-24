...
# Anna - for not hard code indexes you could write first_string[:2] + first_string[-2:]
...
"""It could be different ways to get valuie from the string based of needs, one of the option is following
st = 'I have 123 books'
needed_item = ''
for item in st:
    if item.isdigit():
        needed_item = needed_item+item
reversed_item = (''.join(reversed(needed_item)))
print(needed_item)
print(reversed_item)
...
# Anna - I a bit corrected last funciton
      
# Totally good job Armine jan